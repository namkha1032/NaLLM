...
MERGE (:`Person` {import_name: 'Trevor', `status`: 'alive'  })
MERGE (:`Person` {import_name: 'Lester', `occupation`: 'remote contact'  })
MERGE (:`Organization` {import_name: 'FIB'  })
MERGE (:`Person` {import_name: 'Michael De Santa', `status`: 'alive', `new name`: 'Michael De Santa'  })
MERGE (:`Person` {import_name: 'Dave Norton', `occupation`: 'FIB agent'  })
MERGE (:`Person` {import_name: 'Franklin', `status`: 'alive'  })
MERGE (:`Person` {import_name: 'Lamar', `status`: 'alive'  })
...
MERGE (:`Person` {import_name: 'Trevor', `occupation`: 'criminal', `location`: 'Los Santos'  })
...
MERGE (:`Location` {import_name: 'Los Santos'  })
MERGE (:`Person` {import_name: 'Michael', `occupation`: 'criminal', `location`: 'Los Santos'  })
...
MERGE (:`Person` {import_name: 'Floyd', `relation`: 'cousin'  })
...
MERGE (:`Person` {import_name: 'Steve Haines', `occupation`: 'corrupt FIB agent'  })
MERGE (:`Person` {import_name: 'Franklin', `occupation`: 'criminal', `location`: 'Los Santos'  })
...
MERGE (:`Person` {import_name: 'Devin Weston', `occupation`: 'billionaire'  })
MERGE (:`Person` {import_name: 'Solomon Richards', `occupation`: 'Vinewood producer'  })
MERGE (:`Person` {import_name: 'Patricia', `occupation`: 'kidnapped'  })
MERGE (:`Person` {import_name: 'trevor', `status`: 'alive', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'michael', `status`: 'alive', `occupation`: 'retired criminal'  })
MERGE (:`Person` {import_name: 'patricia', `status`: 'alive', `relationship`: 'wife'  })
MERGE (:`Person` {import_name: 'floyd', `status`: 'deceased', `occupation`: 'associate'  })
MERGE (:`Person` {import_name: 'brad', `status`: 'deceased', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'franklin', `status`: 'alive', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'dave norton', `status`: 'alive', `occupation`: 'FIB agent'  })
MERGE (:`Person` {import_name: 'steve haines', `status`: 'deceased', `occupation`: 'FIB agent'  })
MERGE (:`Person` {import_name: 'devin weston', `status`: 'deceased', `occupation`: 'businessman'  })
...
MERGE (:`Person` {import_name: 'Michael', `status`: 'deceased'  })
MERGE (:`Person` {import_name: 'Trevor', `status`: 'alive'  })
MERGE (:`Person` {import_name: 'Lester', `status`: 'alive'  })
MERGE (:`Group` {import_name: 'Ballas'  })
MERGE (:`Person` {import_name: 'Steve Haines', `status`: 'deceased'  })
MERGE (:`Group` {import_name: 'Triads'  })
MERGE (:`Group` {import_name: 'Merryweather'  })
MERGE (:`Person` {import_name: 'Devin Weston', `status`: 'deceased'  })
MERGE (:`Person` {import_name: 'Dave Norton', `status`: 'alive'  })
MERGE (:`Person` {import_name: 'Jimmy', `status`: 'alive'  })
