...
CREATE (:`FictionalCharacter` {import_name: 'Carl Johnson', `full_name`: 'Carl Johnson', `nickname`: 'CJ'  })
CREATE (:`GameDeveloper` {import_name: 'Rockstar Games'  })
CREATE (:`GamePublisher` {import_name: 'Take-Two Interactive'  })
CREATE (:`FictionalCharacter` {import_name: 'Carl Johnson'  })
CREATE (:`VideoGame` {import_name: 'Grand Theft Auto: San Andreas'  })
...
CREATE (:`GameDeveloper` {import_name: 'Rockstar Games'  })
CREATE (:`GamePublisher` {import_name: 'Take-Two Interactive'  })
CREATE (:`FictionalCharacter` {import_name: 'Carl Johnson', `name`: 'Carl Johnson'  })
CREATE (:`VideoGame` {import_name: 'Grand Theft Auto: San Andreas'  })
...
CREATE (:`FictionalCharacter` {import_name: 'CJ'  })
CREATE (:`FictionalCharacter` {import_name: 'Kendl'  })
...
CREATE (:`FictionalCharacter` {import_name: 'Ryder'  })
...
CREATE (:`FictionalCharacter` {import_name: 'Sweet', `name`: 'Sweet'  })
CREATE (:`FictionalCharacter` {import_name: 'Tenpenny', `name`: 'Tenpenny'  })
CREATE (:`FictionalCharacter` {import_name: 'CJ', `name`: 'CJ'  })
...
CREATE (:`FictionalCharacter` {import_name: 'Smoke'  })
CREATE (:`FictionalCharacter` {import_name: 'Tenpenny'  })
CREATE (:`FictionalCharacter` {import_name: 'Sweet'  });
...
MATCH (source { import_name: 'Rockstar Games' }), (target { import_name: 'Grand Theft Auto: San Andreas' }) CREATE (source)-[:`developed` {}]->(target);
MATCH (source { import_name: 'Take-Two Interactive' }), (target { import_name: 'Grand Theft Auto: San Andreas' }) CREATE (source)-[:`published` {}]->(target);
MATCH (source { import_name: 'Grand Theft Auto: San Andreas' }), (target { import_name: 'Rockstar Games' }) CREATE (source)-[:`developed by` {}]->(target);
MATCH (source { import_name: 'Grand Theft Auto: San Andreas' }), (target { import_name: 'Take-Two Interactive' }) CREATE (source)-[:`published by` {}]->(target);
