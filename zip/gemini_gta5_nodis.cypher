...
MERGE (:`Person` {import_name: 'brad', `occupation`: 'bank robber'  })
MERGE (:`Person` {import_name: 'trevor', `occupation`: 'bank robber'  })
MERGE (:`Person` {import_name: 'lester', `occupation`: 'remote contact for bank robbers'  })
MERGE (:`Person` {import_name: 'unnamed_getaway_driver', `occupation`: 'getaway driver for bank robbers'  })
MERGE (:`Organization` {import_name: 'fib', `type`: 'Federal Investigation Bureau'  })
MERGE (:`Person` {import_name: 'dave_norton', `occupation`: 'FIB agent'  })
MERGE (:`Alias` {import_name: 'michael_de_santa', `real_name`: 'Michael Townley'  })
MERGE (:`Person` {import_name: 'lamar', `occupation`: 'gang banger'  })
MERGE (:`Person` {import_name: 'franklin', `occupation`: 'gang banger'  })
...
MERGE (:`Location` {import_name: 'prison'  })
MERGE (:`Person` {import_name: 'trevor', `name`: 'Trevor', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'michael', `name`: 'Michael', `occupation`: 'former criminal'  })
MERGE (:`Person` {import_name: 'franklin', `name`: 'Franklin', `occupation`: 'criminal'  })
...
MERGE (:`Person` {import_name: 'madrazo', `name`: 'Madrazo', `occupation`: 'drug lord'  })
...
MERGE (:`Person` {import_name: 'floyd', `name`: 'Floyd', `occupation`: 'longshoreman'  })
MERGE (:`Organization` {import_name: 'fib', `name`: 'FIB'  })
MERGE (:`Person` {import_name: 'dave_norton', `name`: 'Dave Norton', `occupation`: 'FIB agent'  })
MERGE (:`Organization` {import_name: 'iaa', `name`: 'IAA'  })
MERGE (:`Person` {import_name: 'ferdinand_kerimov', `name`: 'Ferdinand Kerimov', `occupation`: 'suspected terrorist'  })
MERGE (:`Person` {import_name: 'steve_haines', `name`: 'Steve Haines', `occupation`: 'FIB agent'  })
MERGE (:`Organization` {import_name: 'merryweather_security', `name`: 'Merryweather Security'  })
MERGE (:`Person` {import_name: 'devin_weston', `name`: 'Devin Weston', `occupation`: 'billionaire'  })
MERGE (:`Person` {import_name: 'solomon_richards', `name`: 'Solomon Richards', `occupation`: 'Vinewood producer'  })
MERGE (:`Person` {import_name: 'patricia', `name`: 'Patricia', `occupation`: 'Madrazo\'s wife'  })
MERGE (:`Character` {import_name: 'Trevor', `Occupation`: 'Criminal', `Status`: 'Alive', `name`: 'Trevor'  })
MERGE (:`Character` {import_name: 'Michael', `Occupation`: 'Criminal', `Status`: 'Alive', `name`: 'Michael'  })
MERGE (:`Character` {import_name: 'Franklin', `Occupation`: 'Criminal', `Status`: 'Alive', `name`: 'Franklin'  })
MERGE (:`Company` {import_name: 'Merryweather', `Type`: 'Military Company'  })
...
MERGE (:`Character` {import_name: 'Lester', `Occupation`: 'Hacker', `Status`: 'Alive', `name`: 'Lester'  })
...
MERGE (:`Organization` {import_name: 'IAA', `Type`: 'Government Agency'  })
MERGE (:`Organization` {import_name: 'Triads', `Type`: 'Criminal Syndicate'  })
MERGE (:`Organization` {import_name: 'Ballas', `Type`: 'Criminal Gang'  })
MERGE (:`Character` {import_name: 'Brad', `Status`: 'Deceased', `name`: 'Brad'  })
MERGE (:`Organization` {import_name: 'Lost Santos Police Department', `Type`: 'Police Agency'  })
MERGE (:`Character` {import_name: 'Patricia', `Status`: 'Alive', `name`: 'Patricia'  })
MERGE (:`Character` {import_name: 'Madrazo', `Status`: 'Alive', `name`: 'Madrazo'  })
MERGE (:`Character` {import_name: 'Floyd', `Occupation`: 'Criminal', `Status`: 'Deceased', `name`: 'Floyd'  })
MERGE (:`Character` {import_name: 'Girlfriend', `Occupation`: 'Criminal', `Status`: 'Deceased', `name`: 'Girlfriend'  })
MERGE (:`Facility` {import_name: 'Prison', `Type`: 'Correctional Facility'  })
...
MERGE (:`Webpage` {import_name: 'Webpage', `url`: 'www.alice.com'  })
MERGE (:`Webpage` {import_name: 'Webpage', `url`: 'www.bob.com'  })
MERGE (:`Person` {import_name: 'franklin', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'weston', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'michael', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'trevor', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'lester', `occupation`: 'criminal'  })
MERGE (:`Organization` {import_name: 'ballas', `type`: 'gang'  })
MERGE (:`Person` {import_name: 'steve_haines', `occupation`: 'criminal'  })
MERGE (:`Organization` {import_name: 'triads', `type`: 'gang'  })
MERGE (:`Organization` {import_name: 'merryweather', `type`: 'mercenaries'  })
MERGE (:`Person` {import_name: 'devin_weston', `occupation`: 'criminal'  })
MERGE (:`Person` {import_name: 'dave_norton', `occupation`: 'police officer'  })
MERGE (:`Person` {import_name: 'michael\'s_widow'  })
MERGE (:`Person` {import_name: 'jimmy'  });
